...
public class ChangeCircle : MonoBehaviour
{
	...
	private float ShrinkBy = 1; // 3 minutes 20 seconds to complete
	public GameObject ZoneWall;
	public bool Shrinking, time;
	...
	void Update ()
	{
		if(Shrinking)
		{
			XRadius = Mathf.Lerp(XRadius, ShrinkCircle(ShrinkBy)[0], Time.deltaTime * 0.5f);
